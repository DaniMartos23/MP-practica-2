...
public interface TADcjtRecursos {
	 ...
	 */
	int afegir_Dades(String recurs, String usuari,String data);
	 ...
	 * =-1 si el recurs no existeix
	 */
	int esborrar_Dades(String recurs, String data);
	 ...
	 * 
	 */
	List<String> usuaris_consulta(String recurs,String data);
